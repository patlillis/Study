...
namespace CSharp.Tests
{
    ...
    public class SplayTreeTests
    {
        ...
        public SplayTreeTests()
        {
            ...
            {
                string key = TestUtils.Words[_Rand.Next(0, TestUtils.Words.Count)];
                ...
                value = TestUtils.Words[_Rand.Next(0, TestUtils.Words.Count)];
        ...
        {
            foreach (string w in TestUtils.Shuffle(TestUtils.Words))
            {
